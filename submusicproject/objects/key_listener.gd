...
@onready var falling_key = preload("res://submusicproject/objects/falling_key.tscn")
@onready var score_text = preload("res://submusicproject/objects/score_press_text.tscn")
